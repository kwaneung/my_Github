...
def recolor_image(input_file, k=5):
    img = mpimg.imread(input_file)  # img는 Numpy 배열
    ...
    new_img = [[recolor(pixel) for pixel in row] for row in img]  # 각 픽셀의 색을 군집의 평균색으로 recolor
...
if __name__ == "__main__":
    ...
    # (1) 하나의 클러스터 형성까지 진행, 클러스터간 최소거리를 이용
    ...
    print()
    # (4) 클러스터간 최대거리를 이용하여, 하나의 클러스터 형성까지 진행
